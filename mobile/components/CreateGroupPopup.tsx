...
const CreateGroupPopup: React.FC<CreateGroupPopupProps> = ({ onClose }) => {
  ...
  return (
    <View className="bg-white rounded-xl p-6 w-11/12 max-w-lg items-center shadow-lg relative">
      <TouchableOpacity className="absolute top-2 right-4 p-2" onPress={onClose}>
      ...
      <Text className="text-lg mb-8 text-gray-600 text-center">What should we call your group?</Text>
      <TextInput
      ...
      >
        <Text className="text-white text-lg font-bold">{isPending ? "Creating..." : "Next"}</Text>
      </TouchableOpacity>
